...
public class HelpCommand extends Command {
    ...
    public Response execute(Request request) {
        String helpText = "add : добавить новый элемент в коллекцию\n" +
                "add_if_max {element}: добавить новый элемент, если его значение превышает максимальное\n" +
                "clear : очистить коллекцию\n" +
                "filter_by_group_admin {element}: вывести элементы, значение поля groupAdmin которых равно заданному\n" +
